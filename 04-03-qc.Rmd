...
#### Challenge: The meta.data slot in the Seurat object { - .rmdtip}
...
<!-- #### Challenge: Ribosomal gene expression as a QC metric {- .rmdtip} -->
...
#### Challenge: Filter the cells {- .rmdtip}

Apply the filtering thresolds defined above. 

* How many cells survive filtering?
* Try a different combination of filtering thresholds. How many cells pass that? Remember to assign your results to a different object! 

```{r eval=FALSE}
pbmc_unfiltered <- pbmc
pbmc_qctest <- subset(pbmc_unfiltered, subset = ...)
```
