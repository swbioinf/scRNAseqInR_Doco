# What can we do with a Seurat object? {#seuratobject}
...
And heres the one we prepared earlier. Seurat objects are usually saved as '.rds' files, which is an R format for storing binary data (not-text or human-readable). The functions `readRDS()` can load it.
...
By default this object will return the normalised data - becuase usually that's what you want. Every '.' is a zero.
