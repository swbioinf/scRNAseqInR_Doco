...
1. Look at the counts files.
2. Load them.
3. Look at the cell metadata (there's basically none)
...
<!-- Go look at the input files first --> 
<!-- screenshot a modern 10X output in the full dir structure -->
<!-- maybe an example GEO? --> 
